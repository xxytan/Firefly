...
export const site = {
  ...
  desc: "无聊的一天搭配神经的我～",
  url: "https://b.oxue.de",
  avatar: "https://obb.cc.cd/assets/favicon/1.ico",
  siteshot: "https://obb.cc.cd/assets/img/siteshot.webp",
};
...
> [!TIP] 
> 贵站如需本站其他格式的**站点图标**，可以引用[此链接](https://obb.cc.cd/assets/favicon/)中的资源