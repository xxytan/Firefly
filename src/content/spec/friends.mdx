...
export const site = {
  ...
  desc: "无聊的一天搭配神经的我～",
  url: "https://b.oxue.de",
  avatar: "https://hi.zeas.top/assets/favicon/1.ico",
  siteshot: "https://hi.zeas.top/assets/img/siteshot.webp",
};
...
> [!TIP] 
> 贵站如需本站其他格式的**站点图标**，可以引用[此链接](https://hi.zeas.top/assets/favicon/)中的资源